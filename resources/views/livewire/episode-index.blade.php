    ...
    <div class="w-full flex mb-4 p-2 justify-end">
        <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
            <div class="p-1 flex items-center">
                <label for="episode-number" class="block text-sm font-medium text-gray-700 mr-4">Episode Number</label>
                <div class="relative rounded-md shadow-sm">
                    <input wire:model="episodeNumber" id="episode-number" name="episodeNumber"
                        class="px-3 py-2 border border-gray-300 rounded" placeholder="Episode number" />
                </div>
            </div>
            <div class="p-1 flex items-center">
                <label for="episode-number" class="block text-sm font-medium text-gray-700 mr-4">Episode Url</label>
                <div class="relative rounded-md shadow-sm">
                    <input wire:model="url" id="episode-url" name="url"
                        class="px-3 py-2 border border-gray-300 rounded" placeholder="Episode Url" />
                </div>
            </div>
            <div class="p-1">
                <button type="button" wire:click="createEpisode"
                    class="inline-flex items-center justify-center py-2 px-4 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-gray-800 hover:bg-gray-800 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-green-700 transition duration-150 ease-in-out disabled:opacity-50">
                    <span>Create</span>
                </button>
            </div>
        </form>
    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
        <div class="w-full shadow p-5 bg-white">
            <div class="relative">
                ...
                <input wire:model="search" type="text" placeholder="Search by episode number"
                        ...
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="flex flex-col">
                                    <label for="edit-episode-number" class="block text-sm font-medium text-gray-700 mr-4">Episode
                                        Number</label>
                                    <input wire:model="episodeNumber" id="episode-number" type="text" autocomplete="given-name"
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="flex flex-col">
                                    <label for="edit-url" class="block text-sm font-medium text-gray-700 mr-4">Episode
                                        Url</label>
                                    <input wire:model="url" id="edit-url" type="text" autocomplete="url"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    @error('url')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
