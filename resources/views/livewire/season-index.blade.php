        ...
        <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
            <div class="p-1 flex items-center">
                ...
                <div class="relative rounded-md shadow-sm">
                    <input wire:model="seasonNumber" id="season-number" name="seasonNumber"
                        class="px-3 py-2 border border-gray-300 rounded" placeholder="Season number" />
                </div>
            </div>
            <div class="p-1">
                <button type="button" wire:click="createSeason"
    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
        <div class="w-full shadow p-5 bg-white">
            <div class="relative">
                ...
                <input wire:model="search" type="text" placeholder="Search by number"
                    ...
                    @foreach ($seasons as $season)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-sm border">
                                <a href="{{ route('admin.episodes.index', [$series->id, $season->id]) }}"
